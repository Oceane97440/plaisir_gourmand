            ...
            <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                            <h3 class="panel-title-center">INSCRIPTION <a class="btn btn-info" href="connect.php"role=button> Connexion</a></h3>
                            </div>
                            ...
                            <form method="post" action="">
                                ...
                                <input type="text" name="nom_util" class="form-control input-sm floatlabel" placeholder="Saisir un Nom*"required>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <!--PRENOM-->
                                        <div class="form-group">
                                            <input type="text" name="prenom_util"  class="form-control input-sm" placeholder="Saisir un Prénom*" required  minlength="3" maxlength="15">
                                        </div>
                                    </div>
                                </div>
                                        <!--MAIL-->
                                <div class="form-group">
                                    <input type="email" name="mail" class="form-control input-sm" placeholder="adresse@gmail.com*"required >
                                </div>
                                <!--CONFIRMATION DU MAIL-->
                                <div class="form-group">
                                    <input type="email" name="mail2" class="form-control input-sm" required value="<?php if(isset($mail2)) { echo $mail2; } ?>" placeholder="Confirmation adresse mail*" >
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="password" name="mot_passe" class="form-control input-sm" placeholder="Saisir mot de passe*"required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <input type="tel" name="tel"  class="form-control input-sm" placeholder="06 92 12 34 56" maxlength="10">
                                        </div>
                                    </div>
                                    <!--ROLE-->
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <input type="text" name="specialite"  class="form-control input-sm" placeholder="Spécialités*" required>
                                        </div>
                                    </div>
                                </div>
                                <!--Valider-->
